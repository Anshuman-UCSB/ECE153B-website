...
void I2C_GPIO_Init(void) {
	...
	// Set alternatate function AF4 for PB6&7
...
void I2C_Initialization(void){
	...
	// Set the system clock as the clock source for I2C1
	...
	// Says that NACK is automatically generated in master mode
	// Maybe set it to master mode?
	...
	// f_presc = 80MHz/8 = 10MHz
	// t_presc = 100ns

	// Set SCLDEL (1us)
	I2C1->TIMINGR &= ~I2C_TIMINGR_SCLDEL; 
	I2C1->TIMINGR |= 11<<I2C_TIMINGR_SCLDEL_POS;
	...
	// Set SCLH
	// High Clock period = 4.0 us
	I2C1->TIMINGR &= ~I2C_TIMINGR_SCLH;
	I2C1->TIMINGR |= 41<<I2C_TIMINGR_SCLH_POS;

	// Set SCLL
	// Low Clock period = 4.7 us
	I2C1->TIMINGR &= ~I2C_TIMINGR_SCLL;
	I2C1->TIMINGR |= 48<<I2C_TIMINGR_SCLL_POS;

	// Disable own addresses
